...
export const Dashboard: React.FC<DashboardProps> = ({ user, onLogout }) => {
  ...
  useEffect(() => {
    // On mount, ask Gemini for a personalized welcome
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="p-8 md:p-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              {loadingMessage ? "Connecting to AI..." : welcomeMessage}
            </h2>
            
            <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-8">
              This is a secure dashboard area. The login was successful. 
              {loadingMessage ? "" : " The message above was generated by Gemini 2.5 Flash."}
            </p>
